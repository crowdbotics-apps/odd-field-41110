"""
Django settings for odd_field_41110 project.
...
ROOT_URLCONF = 'odd_field_41110.urls'
...
WSGI_APPLICATION = 'odd_field_41110.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_field_41110 API",
    "DESCRIPTION": "API documentation for odd_field_41110 App",
    "VERSION": "v1",
}
